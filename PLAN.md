...
> 最后更新:2026-09-12(**移动端极端适配 —— 窄屏改「单日纵向时间线」**,见 §0 首条与 `docs/plans/PLAN-20260912002532.md`;
> 上一轮 = 页脚贡献者署名(两个贡献者的 GitHub 主页外链,`PLAN-20260912001500`);
